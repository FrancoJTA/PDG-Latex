...
\begin{itemize}
    \item Analizar los datos históricos disponibles en los módulos del ERP ISI Mustang para la identificación de patrones de desviación y la definición de los casos de uso del módulo predictivo.
    \item Diseñar la arquitectura del módulo predictivo, incluyendo la selección de los modelos de aprendizaje automático adecuados para cada caso de uso.
    \item Construir el módulo predictivo, comprendiendo el pipeline de datos y el entrenamiento de los modelos para los casos de uso definidos.
...
% --- Componentes ---
\node[compex] at (0,-2.9)   {\textbf{PostgreSQL}\\ERP ISI Mustang};
\node[comp]   at (0,-4.9)   {\textbf{Datos complementarios}\\CSV / Parquet};
...
\quad\quad 2.7.4 NestJS y Angular \\[2pt]
